					...
					items: [
						{
							...
							collapsed: true,
							items: [
								{ text: "Login / Sign In", link: "/docs/activity/auth/login" },
								{ text: "Register / Sign Up", link: "/docs/activity/auth/register" },
								{ text: "Forgot Password", link: "/docs/activity/auth/forgot-password" },
								{ text: "Reset Password", link: "/docs/activity/auth/reset-password" },
							],
						},
						{
							text: "User Profile",
							collapsed: true,
							items: [
								{ text: "Update Personal Information", link: "/docs/activity/user-profile/update-personal-information" },
								{ text: "View User Profile", link: "/docs/activity/user-profile/view-user-profile" },
								{ text: "Delete Personal Account", link: "/docs/activity/user-profile/delete-personal-account" },
							],
						},
						{
							text: "User Skills",
							collapsed: true,
							items: [
								{ text: "View Personal Skill List", link: "/docs/activity/user-skills/view-personal-skill-list" },
								{ text: "View Personal Skill Details", link: "/docs/activity/user-skills/view-personal-skill-details" },
								{ text: "Add Personal Skill", link: "/docs/activity/user-skills/add-personal-skill" },
								{ text: "Update Personal Skill", link: "/docs/activity/user-skills/update-personal-skill" },
								{ text: "Delete Personal Skill", link: "/docs/activity/user-skills/delete-personal-skill" },
							],
						},
						{
							text: "System Administration (Admin)",
							collapsed: true,
							items: [
								{ text: "Configure System Parameters", link: "/docs/activity/admin/configure-system-parameters" },
								{ text: "View System Skill Directory", link: "/docs/activity/admin/view-system-skill-directory" },
								{ text: "Add System Skill", link: "/docs/activity/admin/add-system-skill" },
								{ text: "Edit System Skill", link: "/docs/activity/admin/edit-system-skill" },
								{ text: "Delete System Skill", link: "/docs/activity/admin/delete-system-skill" },
								{ text: "View Global User List", link: "/docs/activity/admin/view-global-user-list" },
								{ text: "Add System User", link: "/docs/activity/admin/add-system-user" },
								{ text: "Edit System User", link: "/docs/activity/admin/edit-system-user" },
								{ text: "Delete System User", link: "/docs/activity/admin/delete-system-user" },
							],
						},
						{
							text: "Project Management",
							collapsed: true,
							items: [
								{ text: "View Joined Projects", link: "/docs/activity/project-management/view-joined-projects" },
								{ text: "Create New Project", link: "/docs/activity/project-management/create-new-project" },
								{ text: "View Project Details / Summary", link: "/docs/activity/project-management/view-project-details" },
								{ text: "Update Project Information", link: "/docs/activity/project-management/update-project-information" },
								{ text: "Join Project (via Link/Code)", link: "/docs/activity/project-management/join-project" },
								{ text: "Leave Project", link: "/docs/activity/project-management/leave-project" },
								{ text: "Close / Archive Project", link: "/docs/activity/project-management/close-archive-project" },
							],
						},
						{
							text: "Project Members",
							collapsed: true,
							items: [
								{ text: "View Project Member List", link: "/docs/activity/project-members/view-project-member-list" },
								{ text: "View Member Details", link: "/docs/activity/project-members/view-member-details" },
								{ text: "Add Member to Project", link: "/docs/activity/project-members/add-member-to-project" },
								{ text: "Update Member Role", link: "/docs/activity/project-members/update-member-role" },
								{ text: "Remove Member from Project", link: "/docs/activity/project-members/remove-member-from-project" },
							],
						},
						{
							text: "Sprint Management (Agile)",
							collapsed: true,
							items: [
								{ text: "View Sprint List", link: "/docs/activity/sprint-management/view-sprint-list" },
								{ text: "View Sprint Details", link: "/docs/activity/sprint-management/view-sprint-details" },
								{ text: "Create New Sprint", link: "/docs/activity/sprint-management/create-new-sprint" },
								{ text: "Update Sprint Information", link: "/docs/activity/sprint-management/update-sprint-information" },
								{ text: "Start / Complete Sprint", link: "/docs/activity/sprint-management/start-complete-sprint" },
								{ text: "Delete Sprint", link: "/docs/activity/sprint-management/delete-sprint" },
							],
						},
						{
							text: "Task Management",
							collapsed: true,
							items: [
								{ text: "View Kanban Board", link: "/docs/activity/task-management/view-kanban-board" },
								{ text: "View Backlog", link: "/docs/activity/task-management/view-backlog" },
								{ text: "View Workload", link: "/docs/activity/task-management/view-workload" },
								{ text: "View Task Details", link: "/docs/activity/task-management/view-task-details" },
								{ text: "Create New Task / Sub-task", link: "/docs/activity/task-management/create-new-task" },
								{ text: "Update Task Information", link: "/docs/activity/task-management/update-task-information" },
								{ text: "Update Task Status (Drag & Drop)", link: "/docs/activity/task-management/update-task-status" },
								{ text: "Assign Assignee & Reporter", link: "/docs/activity/task-management/assign-assignee-reporter" },
								{ text: "Delete Task", link: "/docs/activity/task-management/delete-task" },
							],
						},
						{
							text: "Interaction & Communication",
							collapsed: true,
							items: [
								{ text: "View Comments", link: "/docs/activity/interaction-communication/view-comments" },
								{ text: "Write Comment", link: "/docs/activity/interaction-communication/write-comment" },
								{ text: "Edit Comment", link: "/docs/activity/interaction-communication/edit-comment" },
								{ text: "Delete Comment", link: "/docs/activity/interaction-communication/delete-comment" },
							],
						},
						{
							text: "Notification Management",
							collapsed: true,
							items: [
								{ text: "Receive Notification", link: "/docs/activity/notification-management/receive-notification" },
								{ text: "Mark Notification as Read", link: "/docs/activity/notification-management/mark-notification-as-read" },
							],
						},
						{
							text: "AI Assistant",
							collapsed: true,
							items: [
								{ text: "Create New AI Chat Session", link: "/docs/activity/ai-assistant/create-new-ai-chat-session" },
								{ text: "Chat with AI", link: "/docs/activity/ai-assistant/chat-with-ai" },
								{ text: "View AI Chat History", link: "/docs/activity/ai-assistant/view-ai-chat-history" },
								{ text: "View AI Activity Logs", link: "/docs/activity/ai-assistant/view-ai-activity-logs" },
								{ text: "Request AI Auto-Assignment", link: "/docs/activity/ai-assistant/request-ai-auto-assignment" },
							],
						},
					],
				},
