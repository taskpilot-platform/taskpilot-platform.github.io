...
RV -> RC: Request booking report
activate RC
RC -> TB: Get bookings
activate TB
TB -> TB: Query bookings by filters
activate TB
deactivate TB
RC <-- TB: Booking data
deactivate TB
...
<!-- diagram id="sequence-view-reports-booking-report" -->
