# Activity Popular Routes Report
...
:(1) Select function Popular Routes Report;

|S|
:(2) Display report configuration form \n (date range, minimum bookings filter);
...
|S|
:(5) Query popular routes data \n (routes, trips, bookings, revenue);
...
<!-- diagram id="activity-view-reports-popular-routes-report" -->
