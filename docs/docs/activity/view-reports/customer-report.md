...
:(1) Select function Customer Report;

|S|
:(2) Display report configuration form \n (date range, customer type filter);
...
<!-- diagram id="activity-view-reports-customer-report" -->
