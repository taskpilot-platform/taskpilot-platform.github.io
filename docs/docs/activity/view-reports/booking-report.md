...
:(1) Select function Booking Report;

|S|
:(2) Display report configuration form \n (date range, status filter, route filter);
...
<!-- diagram id="activity-view-reports-booking-report" -->
