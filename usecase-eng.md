...
Breakdown of use-cases by Subsystem / Feature Group for system design and development. Every independent action is mapped to a specific requirement file.

| No.      | Subsystem                         | Use-case Name (Action)                       | Actor       | Related Table             |
| :------- | :-------------------------------- | :------------------------------------------- | :---------- | :------------------------ |
